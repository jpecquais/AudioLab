...
class PamRotaryEffect : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = float(fHslider5);
		int iSlow3 = std::fabs(fSlow2) < 1.1920929e-07f;
		float fSlow4 = ((iSlow3) ? 0.0f : std::exp(-(fConst5 / ((iSlow3) ? 1.0f : fSlow2))));
		float fSlow5 = (1.0f - float(fHslider1)) * ((int(float(fHslider2))) ? float(fHslider4) : float(fHslider3)) * (1.0f - fSlow4);
		float fSlow6 = 1.4125376f * std::pow(1e+01f, 0.15f * fSlow0);
		float fSlow7 = 0.01f * float(fHslider6);
		float fSlow8 = std::sqrt(fSlow7);
		float fSlow9 = std::sqrt(1.0f - fSlow7);
		float fSlow10 = 1.0f - fSlow1;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			int iTemp0 = 1 - iVec0[1];
			fRec10[0] = fSlow5 + fSlow4 * fRec10[1];
			...
			float fTemp7 = fSlow8 * fRec13[0];
			fVec2[IOTA0 & 63] = fTemp7;
			float fTemp8 = 0.5f * (fRec11[(IOTA0 - 31) & 31] + fRec11[(IOTA0 - 17) & 31] + fRec12[(IOTA0 - 23) & 31] + fRec12[(IOTA0 - 11) & 31] + fRec12[IOTA0 & 31] + fRec11[IOTA0 & 31]) + fSlow6 * (1.0f * fVec2[(IOTA0 - 48) & 63] + 1.5543122e-15f * fVec2[(IOTA0 - 49) & 63]);
			fVec3[IOTA0 & 127] = fTemp8;
			int iTemp9 = int(fTemp4);
			float fTemp10 = (fTemp3 - fTemp5) * fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp9 + 1))) & 127] - fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp9))) & 127] * (fTemp3 + (-1.0f - fTemp5));
			fVec4[0] = fTemp10;
			fRec8[0] = -(fConst2 * (fConst3 * fRec8[1] - (fTemp10 + fVec4[1])));
			fRec4[0] = fRec8[0];
			float fTemp11 = ((iTemp0) ? 1.5707964f : fRec15[1] - fConst9 * fRec10[0]);
			fRec15[0] = fTemp11 - std::floor(fTemp11);
			float fTemp12 = std::cos(6.2831855f * fRec15[0] + -3.1415927f);
			float fTemp13 = fConst4 * (fTemp12 + 1.0f);
			float fTemp14 = fTemp13 + 7.000005f;
			float fTemp15 = std::floor(fTemp14);
			int iTemp16 = int(fTemp14);
			float fTemp17 = (fTemp13 + (7.0f - fTemp15)) * fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp16 + 1))) & 127] - fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp16))) & 127] * (fTemp13 + (6.0f - fTemp15));
			fVec5[0] = fTemp17;
			fRec14[0] = -(fConst2 * (fConst3 * fRec14[1] - (fTemp17 + fVec5[1])));
			fRec5[0] = fRec14[0];
			float fRec6 = 0.5f * (fTemp8 + fVec3[(IOTA0 - 11) & 127] + fVec3[(IOTA0 - 23) & 127]);
			float fRec7 = 0.5f * (fTemp8 + fVec3[(IOTA0 - 17) & 127] + fVec3[(IOTA0 - 31) & 127]);
			float fTemp18 = fRec5[0] + fRec7;
			fVec6[0] = fTemp18;
			float fTemp19 = 0.70710677f * fVec6[1];
			fVec7[0] = 0.260502f * fRec2[1] + fTemp19;
			fRec3[0] = fVec7[1] + 0.018165573f * fVec6[1] - (0.02569f * fRec3[1] + 0.18420273f * fTemp18);
			fRec2[0] = fRec3[0];
			fVec8[0] = fRec2[1] - 0.870686f * fRec0[1];
			fRec1[0] = 1.8685f * (fRec1[1] - fRec2[1]) + fVec8[1] + 0.870686f * fRec2[0];
			fRec0[0] = fRec1[0];
			float fTemp20 = 3.1415927f * fTemp12;
			fRec16[0] = fConst10 * std::cos(fTemp20) + fConst11 * fRec16[1];
			fVec9[0] = fTemp19 - 0.94657f * fRec19[1];
			fRec20[0] = 0.66932607f * fTemp18 + 1.94632f * fRec20[1] + fVec9[1] - 1.3762561f * fVec6[1];
			fRec19[0] = fRec20[0];
			fVec10[0] = fRec19[1] - 0.06338f * fRec17[1];
			fRec18[0] = 0.06338f * fRec19[0] + fVec10[1] + 0.83774f * (fRec18[1] - fRec19[1]);
			fRec17[0] = fRec18[0];
			fRec21[0] = fConst10 * std::sin(fTemp20) + fConst11 * fRec21[1];
			fRec26[0] = -(fConst7 * (fConst8 * fRec26[1] - (fTemp6 + fVec1[1])));
			float fTemp21 = fRec26[0] + fSlow9 * fRec13[0];
			fVec11[0] = fTemp21;
			fVec12[0] = 0.260502f * fRec24[1] + fVec11[1];
			fRec25[0] = fVec12[1] - (0.02569f * (fRec25[1] - fVec11[1]) + 0.260502f * fTemp21);
			fRec24[0] = fRec25[0];
			fVec13[0] = fRec24[1] - 0.870686f * fRec22[1];
			fRec23[0] = 1.8685f * (fRec23[1] - fRec24[1]) + fVec13[1] + 0.870686f * fRec24[0];
			fRec22[0] = fRec23[0];
			output0[i0] = FAUSTFLOAT(fSlow1 * (fRec0[0] * fRec16[0] + fRec17[0] * fRec21[0]) + fRec22[0] + fSlow10 * fRec0[0]);
			float fTemp22 = fRec4[0] + fRec6;
			fVec14[0] = fTemp22;
			float fTemp23 = 0.70710677f * fVec14[1];
			fVec15[0] = 0.260502f * fRec29[1] + fTemp23;
			fRec30[0] = fVec15[1] + 0.018165573f * fVec14[1] - (0.02569f * fRec30[1] + 0.18420273f * fTemp22);
			fRec29[0] = fRec30[0];
			fVec16[0] = fRec29[1] - 0.870686f * fRec27[1];
			fRec28[0] = fVec16[1] + 0.870686f * fRec29[0] - 1.8685f * (fRec29[1] - fRec28[1]);
			fRec27[0] = fRec28[0];
			float fTemp24 = 3.1415927f * fTemp2;
			fRec31[0] = fConst10 * std::cos(fTemp24) + fConst11 * fRec31[1];
			fVec17[0] = fTemp23 - 0.94657f * fRec34[1];
			fRec35[0] = fVec17[1] + 1.94632f * fRec35[1] + 0.66932607f * fTemp22 - 1.3762561f * fVec14[1];
			fRec34[0] = fRec35[0];
			...
			output1[i0] = FAUSTFLOAT(fRec22[0] + fSlow10 * fRec27[0] + fSlow1 * (fRec27[0] * fRec31[0] + fRec32[0] * fRec36[0]));
			iVec0[1] = iVec0[0];
			fRec10[1] = fRec10[0];
			fRec9[1] = fRec9[0];
			IOTA0 = IOTA0 + 1;
