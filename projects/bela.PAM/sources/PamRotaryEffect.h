...
class PamRotaryEffect : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst6 = 0.0002647059f * fConst0;
		fConst7 = 1.0f / fConst0;
		fConst8 = 1.0f / std::tan(4.712389f / fConst0);
		fConst9 = 1.0f / (fConst8 + 1.0f);
		fConst10 = 1.0f - fConst8;
		fConst11 = 9.424778f / fConst0;
		fConst12 = std::sin(fConst11);
		fConst13 = std::cos(fConst11);
		fConst14 = 1.0f / std::tan(14137.167f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec23[0] = fConst12 * fRec24[1] + fConst13 * fRec23[1];
			fRec24[0] = float(iTemp2) + fConst13 * fRec24[1] - fConst12 * fRec23[1];
			...
			fRec21[0] = -(fConst9 * (fConst10 * fRec21[1] - (fRec22[0] + fRec22[1])));
			fRec20[0] = -(fConst9 * (fConst10 * fRec20[1] - (fRec21[0] + fRec21[1])));
			fRec19[0] = -(fConst9 * (fConst10 * fRec19[1] - (fRec20[0] + fRec20[1])));
			fRec18[0] = -(fConst9 * (fConst10 * fRec18[1] - (fRec19[0] + fRec19[1])));
			fRec17[0] = -(fConst9 * (fConst10 * fRec17[1] - (fRec18[0] + fRec18[1])));
			float fTemp4 = 0.125f * fRec17[0] + 1.0f;
			float fTemp5 = fRec16[0] * fTemp4;
			float fTemp6 = ((iTemp2) ? 1.5707964f : fRec15[1] - fConst7 * fTemp5);
			fRec15[0] = fTemp6 - std::floor(fTemp6);
			float fTemp7 = std::cos(6.2831855f * fRec15[0] + -3.1415927f);
			float fTemp8 = fConst6 * (fTemp7 + 1.0f);
			float fTemp9 = fTemp8 + 5e-06f;
			float fTemp10 = std::floor(fTemp9);
			fRec26[IOTA0 & 31] = -(fConst15 * (fConst16 * fRec26[(IOTA0 - 1) & 31] + 0.16666667f * (fRec12[1] + fRec12[2])));
			fRec27[IOTA0 & 31] = -(fConst15 * (fConst16 * fRec27[(IOTA0 - 1) & 31] + 0.16666667f * (fRec11[1] + fRec11[2])));
			...
			fRec11[0] = (fTemp8 - fTemp10) * fVec6[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp17 + 1))) & 127] - fVec6[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp17))) & 127] * (fTemp8 + (-1.0f - fTemp10));
			float fTemp18 = ((iTemp2) ? 1.5707964f : fRec28[1] - fConst17 * fTemp5);
			fRec28[0] = fTemp18 - std::floor(fTemp18);
			float fTemp19 = std::cos(6.2831855f * fRec28[0] + -3.1415927f);
			float fTemp20 = fConst6 * (fTemp19 + 1.0f);
			float fTemp21 = fTemp20 + 7.000005f;
			float fTemp22 = std::floor(fTemp21);
			int iTemp23 = int(fTemp21);
			fRec12[0] = (fTemp20 + (7.0f - fTemp22)) * fVec6[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp23 + 1))) & 127] - fVec6[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp23))) & 127] * (fTemp20 + (6.0f - fTemp22));
			...
			float fTemp24 = fRec12[0] + fRec14;
			fVec7[0] = fTemp24;
			fRec10[0] = fConst5 * fRec10[1] + 0.70710677f * (fVec7[1] - fConst5 * fTemp24);
			fVec8[0] = 0.260502f * fRec8[1] - 0.5f * fRec10[1];
			fRec9[0] = fVec8[1] + 0.130251f * fRec10[0] - (0.02569f * fRec9[1] + 0.012845f * fRec10[1]);
			fRec8[0] = fRec9[0];
			fVec9[0] = fRec8[1] - 0.870686f * fRec6[1];
			fRec7[0] = 1.8685f * (fRec7[1] - fRec8[1]) + fVec9[1] + 0.870686f * fRec8[0];
			fRec6[0] = fRec7[0];
			float fTemp25 = 0.70710677f * fVec7[1];
			fVec10[0] = fTemp25 + 0.260502f * fRec31[1];
			fRec32[0] = fVec10[1] + 0.018165573f * fVec7[1] - (0.02569f * fRec32[1] + 0.18420273f * fTemp24);
			fRec31[0] = fRec32[0];
			fVec11[0] = fRec31[1] - 0.870686f * fRec29[1];
			fRec30[0] = 1.8685f * (fRec30[1] - fRec31[1]) + fVec11[1] + 0.870686f * fRec31[0];
			fRec29[0] = fRec30[0];
			float fTemp26 = 3.1415927f * fTemp19;
			fRec33[0] = fConst18 * std::cos(fTemp26) + fConst19 * fRec33[1];
			fVec12[0] = fTemp25 - 0.94657f * fRec36[1];
			fRec37[0] = fVec12[1] + 1.94632f * fRec37[1] + 0.66932607f * fTemp24 - 1.3762561f * fVec7[1];
			fRec36[0] = fRec37[0];
			fVec13[0] = fRec36[1] - 0.06338f * fRec34[1];
			fRec35[0] = 0.83774f * (fRec35[1] - fRec36[1]) + fVec13[1] + 0.06338f * fRec36[0];
			fRec34[0] = fRec35[0];
			fRec38[0] = fConst18 * std::sin(fTemp26) + fConst19 * fRec38[1];
			float fTemp27 = 0.70710677f * (fSlow4 * fRec6[0] + fSlow3 * (fRec29[0] * fRec33[0] + fRec34[0] * fRec38[0]));
			output0[i0] = FAUSTFLOAT(fRec0[0] + fTemp27);
			float fTemp28 = fRec11[0] + fRec13;
			fVec14[0] = fTemp28;
			float fTemp29 = 0.70710677f * fVec14[1];
			fVec15[0] = fTemp29 + 0.260502f * fRec41[1];
			fRec42[0] = fVec15[1] + 0.018165573f * fVec14[1] - (0.02569f * fRec42[1] + 0.18420273f * fTemp28);
			fRec41[0] = fRec42[0];
			fVec16[0] = fRec41[1] - 0.870686f * fRec39[1];
			fRec40[0] = 1.8685f * (fRec40[1] - fRec41[1]) + fVec16[1] + 0.870686f * fRec41[0];
			fRec39[0] = fRec40[0];
			float fTemp30 = 3.1415927f * fTemp7;
			fRec43[0] = fConst18 * std::cos(fTemp30) + fConst19 * fRec43[1];
			fVec17[0] = fTemp29 - 0.94657f * fRec46[1];
			fRec47[0] = fVec17[1] + 1.94632f * fRec47[1] + 0.66932607f * fTemp28 - 1.3762561f * fVec14[1];
			fRec46[0] = fRec47[0];
			fVec18[0] = fRec46[1] - 0.06338f * fRec44[1];
			fRec45[0] = 0.83774f * (fRec45[1] - fRec46[1]) + fVec18[1] + 0.06338f * fRec46[0];
			fRec44[0] = fRec45[0];
			fRec48[0] = fConst18 * std::sin(fTemp30) + fConst19 * fRec48[1];
			fRec53[0] = fConst5 * fRec53[1] + 0.70710677f * (fVec14[1] - fConst5 * fTemp28);
			fVec19[0] = 0.260502f * fRec51[1] - 0.5f * fRec53[1];
			fRec52[0] = fVec19[1] + 0.130251f * fRec53[0] - (0.02569f * fRec52[1] + 0.012845f * fRec53[1]);
			fRec51[0] = fRec52[0];
			fVec20[0] = fRec51[1] - 0.870686f * fRec49[1];
			fRec50[0] = 1.8685f * (fRec50[1] - fRec51[1]) + fVec20[1] + 0.870686f * fRec51[0];
			fRec49[0] = fRec50[0];
			output1[i0] = FAUSTFLOAT(fTemp27 + fSlow3 * (fRec39[0] * fRec43[0] + fRec44[0] * fRec48[0]) + fRec0[0] + fSlow4 * fRec49[0]);
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			fRec4[1] = fRec4[0];
			fRec5[1] = fRec5[0];
