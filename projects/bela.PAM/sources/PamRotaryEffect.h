 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec17[0] = fConst9 * fRec18[1] + fConst10 * fRec17[1];
			fRec18[0] = float(iTemp0) + fConst10 * fRec18[1] - fConst9 * fRec17[1];
			int iTemp1 = (fRec17[1] <= 0.0f) & (fRec17[0] > 0.0f);
			iRec19[0] = 1103515245 * iRec19[1] + 12345;
			fRec16[0] = fRec16[1] * float(1 - iTemp1) + 4.656613e-10f * float(iRec19[0]) * float(iTemp1);
			fRec15[0] = -(fConst6 * (fConst7 * fRec15[1] - (fRec16[0] + fRec16[1])));
			fRec14[0] = -(fConst6 * (fConst7 * fRec14[1] - (fRec15[0] + fRec15[1])));
			fRec13[0] = -(fConst6 * (fConst7 * fRec13[1] - (fRec14[0] + fRec14[1])));
			fRec12[0] = -(fConst6 * (fConst7 * fRec12[1] - (fRec13[0] + fRec13[1])));
			fRec11[0] = -(fConst6 * (fConst7 * fRec11[1] - (fRec12[0] + fRec12[1])));
			float fTemp2 = 0.125f * fRec11[0] + 1.0f;
			float fTemp3 = fRec10[0] * fTemp2;
			...
			fRec20[IOTA0 & 31] = -(fConst2 * (fConst11 * fRec20[(IOTA0 - 1) & 31] + 0.16666667f * (fRec5[1] + fRec5[2])));
			fRec21[IOTA0 & 31] = -(fConst2 * (fConst11 * fRec21[(IOTA0 - 1) & 31] + 0.16666667f * (fRec4[2] + fRec4[1])));
			...
			fVec4[0] = fTemp17;
			fRec8[0] = fConst2 * (fTemp17 + fVec4[1] - fConst11 * fRec8[1]);
			fRec4[0] = fRec8[0];
			...
			float fTemp20 = fConst3 * (fTemp19 + 1.0f);
			...
			fVec5[0] = fTemp24;
			fRec23[0] = -(fConst2 * (fConst11 * fRec23[1] - (fTemp24 + fVec5[1])));
			fRec5[0] = fRec23[0];
			...
			fRec25[0] = fConst16 * std::cos(fTemp27) + fConst17 * fRec25[1];
			...
			fRec26[0] = fRec27[0];
			fRec30[0] = fConst16 * std::sin(fTemp27) + fConst17 * fRec30[1];
			fRec35[0] = -(fConst13 * (fConst14 * fRec35[1] - (fTemp12 + fVec1[1])));
			float fTemp28 = fRec35[0] + fSlow10 * fRec22[0];
			fVec11[0] = fTemp28;
			fVec12[0] = 0.260502f * fRec33[1] + fVec11[1];
			fRec34[0] = fVec12[1] - (0.02569f * (fRec34[1] - fVec11[1]) + 0.260502f * fTemp28);
			fRec33[0] = fRec34[0];
			fVec13[0] = fRec33[1] - 0.870686f * fRec31[1];
			fRec32[0] = 1.8685f * (fRec32[1] - fRec33[1]) + fVec13[1] + 0.870686f * fRec33[0];
			fRec31[0] = fRec32[0];
			output0[i0] = FAUSTFLOAT(fSlow2 * fRec0[0] + fSlow1 * (fRec0[0] * fRec25[0] + fRec26[0] * fRec30[0]) + fRec31[0]);
			float fTemp29 = fRec4[0] + fRec6;
			fVec14[0] = fTemp29;
			float fTemp30 = 0.70710677f * fVec14[1];
			fVec15[0] = fTemp30 + 0.260502f * fRec38[1];
			fRec39[0] = fVec15[1] + 0.018165573f * fVec14[1] - (0.18420273f * fTemp29 + 0.02569f * fRec39[1]);
			fRec38[0] = fRec39[0];
			fVec16[0] = fRec38[1] - 0.870686f * fRec36[1];
			fRec37[0] = 0.870686f * fRec38[0] + fVec16[1] + 1.8685f * (fRec37[1] - fRec38[1]);
			fRec36[0] = fRec37[0];
			float fTemp31 = 3.1415927f * fTemp5;
			fRec40[0] = fConst16 * std::cos(fTemp31) + fConst17 * fRec40[1];
			fVec17[0] = fTemp30 - 0.94657f * fRec43[1];
			fRec44[0] = 1.94632f * fRec44[1] + fVec17[1] + 0.66932607f * fTemp29 - 1.3762561f * fVec14[1];
			fRec43[0] = fRec44[0];
			fVec18[0] = fRec43[1] - 0.06338f * fRec41[1];
			fRec42[0] = 0.06338f * fRec43[0] + fVec18[1] + 0.83774f * (fRec42[1] - fRec43[1]);
			fRec41[0] = fRec42[0];
			fRec45[0] = fConst16 * std::sin(fTemp31) + fConst17 * fRec45[1];
			output1[i0] = FAUSTFLOAT(fSlow2 * fRec36[0] + fSlow1 * (fRec36[0] * fRec40[0] + fRec41[0] * fRec45[0]) + fRec31[0]);
			iVec0[1] = iVec0[0];
			fRec10[1] = fRec10[0];
			fRec17[1] = fRec17[0];
			fRec18[1] = fRec18[0];
