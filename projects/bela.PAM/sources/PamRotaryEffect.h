...
class PamRotaryEffect : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = (fConst1 + -1.0f) / (fConst1 + 1.0f);
		fConst3 = 0.0002647059f * fConst0;
		fConst4 = 1.0f / fConst0;
		fConst5 = 1.0f / std::tan(4.712389f / fConst0);
		fConst6 = 1.0f / (fConst5 + 1.0f);
		fConst7 = 1.0f - fConst5;
		fConst8 = 9.424778f / fConst0;
		fConst9 = std::sin(fConst8);
		fConst10 = std::cos(fConst8);
		fConst11 = 1.0f / std::tan(14137.167f / fConst0);
		fConst12 = 1.0f / (fConst11 + 1.0f);
		fConst13 = 1.0f - fConst11;
		fConst14 = 1.0f / std::tan(3769.9111f / fConst0);
		fConst15 = 1.0f / (fConst14 + 1.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("slow_rotation_speed", &fHslider3, FAUSTFLOAT(0.8f), FAUSTFLOAT(0.1f), FAUSTFLOAT(4.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = ((iSlow4) ? 0.0f : std::exp(-(fConst4 / ((iSlow4) ? 1.0f : fSlow3))));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec15[0] = fRec15[1] * float(1 - iTemp1) + 4.656613e-10f * float(iRec18[0]) * float(iTemp1);
			fRec14[0] = -(fConst6 * (fConst7 * fRec14[1] - (fRec15[1] + fRec15[0])));
			fRec13[0] = -(fConst6 * (fConst7 * fRec13[1] - (fRec14[1] + fRec14[0])));
			fRec12[0] = -(fConst6 * (fConst7 * fRec12[1] - (fRec13[1] + fRec13[0])));
			fRec11[0] = -(fConst6 * (fConst7 * fRec11[1] - (fRec12[1] + fRec12[0])));
			fRec10[0] = -(fConst6 * (fConst7 * fRec10[1] - (fRec11[1] + fRec11[0])));
			float fTemp2 = 0.125f * fRec10[0] + 1.0f;
			fRec19[0] = fSlow6 + fSlow5 * fRec19[1];
			float fTemp3 = fTemp2 * fRec19[0];
			float fTemp4 = ((iTemp0) ? 1.5707964f : fRec9[1] - fConst4 * fTemp3);
			fRec9[0] = fTemp4 - std::floor(fTemp4);
			float fTemp5 = std::cos(6.2831855f * fRec9[0] + -3.1415927f);
			float fTemp6 = fConst3 * (fTemp5 + 1.0f);
			float fTemp7 = fTemp6 + 5e-06f;
			float fTemp8 = std::floor(fTemp7);
			fRec20[IOTA0 & 31] = -(fConst12 * (fConst13 * fRec20[(IOTA0 - 1) & 31] + 0.16666667f * (fRec6[1] + fRec6[2])));
			fRec21[IOTA0 & 31] = -(fConst12 * (fConst13 * fRec21[(IOTA0 - 1) & 31] + 0.16666667f * (fRec5[1] + fRec5[2])));
			float fTemp9 = 48.0f * fTemp2;
			float fTemp10 = fTemp9 + 5e-06f;
			float fTemp11 = std::floor(fTemp10);
			float fTemp12 = float(input0[i0]);
			fVec1[0] = fTemp12;
			fRec22[0] = -(fConst15 * (fConst16 * fRec22[1] - fConst14 * (fTemp12 - fVec1[1])));
			...
			fRec5[0] = (fTemp6 - fTemp8) * fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp16 + 1))) & 127] - fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp16))) & 127] * (fTemp6 + (-1.0f - fTemp8));
			float fTemp17 = ((iTemp0) ? 1.5707964f : fRec23[1] - fConst17 * fTemp3);
			fRec23[0] = fTemp17 - std::floor(fTemp17);
			float fTemp18 = std::cos(6.2831855f * fRec23[0] + -3.1415927f);
			float fTemp19 = fConst3 * (fTemp18 + 1.0f);
			float fTemp20 = fTemp19 + 7.000005f;
			float fTemp21 = std::floor(fTemp20);
			int iTemp22 = int(fTemp20);
			fRec6[0] = (fTemp19 + (7.0f - fTemp21)) * fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp22 + 1))) & 127] - fVec3[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp22))) & 127] * (fTemp19 + (6.0f - fTemp21));
			float fRec7 = 0.5f * (fTemp15 + fVec3[(IOTA0 - 11) & 127] + fVec3[(IOTA0 - 23) & 127]);
			float fRec8 = 0.5f * (fTemp15 + fVec3[(IOTA0 - 17) & 127] + fVec3[(IOTA0 - 31) & 127]);
			float fTemp23 = fRec6[0] + fRec8;
			fVec4[0] = fTemp23;
			fRec4[0] = fConst2 * fRec4[1] + 0.70710677f * (fVec4[1] - fConst2 * fTemp23);
			fVec5[0] = 0.260502f * fRec2[1] - 0.5f * fRec4[1];
			fRec3[0] = fVec5[1] + 0.130251f * fRec4[0] - (0.02569f * fRec3[1] + 0.012845f * fRec4[1]);
			fRec2[0] = fRec3[0];
			fVec6[0] = fRec2[1] - 0.870686f * fRec0[1];
			fRec1[0] = 0.870686f * fRec2[0] + fVec6[1] + 1.8685f * (fRec1[1] - fRec2[1]);
			fRec0[0] = fRec1[0];
			float fTemp24 = 0.70710677f * fVec4[1];
			fVec7[0] = fTemp24 + 0.260502f * fRec26[1];
			fRec27[0] = fVec7[1] + 0.018165573f * fVec4[1] - (0.02569f * fRec27[1] + 0.18420273f * fTemp23);
			fRec26[0] = fRec27[0];
			fVec8[0] = fRec26[1] - 0.870686f * fRec24[1];
			fRec25[0] = 0.870686f * fRec26[0] + fVec8[1] + 1.8685f * (fRec25[1] - fRec26[1]);
			fRec24[0] = fRec25[0];
			float fTemp25 = 3.1415927f * fTemp18;
			fRec28[0] = fConst18 * std::cos(fTemp25) + fConst19 * fRec28[1];
			fVec9[0] = fTemp24 - 0.94657f * fRec31[1];
			fRec32[0] = 1.94632f * fRec32[1] + fVec9[1] + 0.66932607f * fTemp23 - 1.3762561f * fVec4[1];
			fRec31[0] = fRec32[0];
			fVec10[0] = fRec31[1] - 0.06338f * fRec29[1];
			fRec30[0] = 0.06338f * fRec31[0] + fVec10[1] + 0.83774f * (fRec30[1] - fRec31[1]);
			fRec29[0] = fRec30[0];
			fRec33[0] = fConst18 * std::sin(fTemp25) + fConst19 * fRec33[1];
			fRec38[0] = -(fConst15 * (fConst16 * fRec38[1] - (fTemp12 + fVec1[1])));
			float fTemp26 = fSlow10 * fRec22[0] + fRec38[0];
			fVec11[0] = fTemp26;
			fVec12[0] = 0.260502f * fRec36[1] + fVec11[1];
			fRec37[0] = fVec12[1] - (0.02569f * (fRec37[1] - fVec11[1]) + 0.260502f * fTemp26);
			fRec36[0] = fRec37[0];
			fVec13[0] = fRec36[1] - 0.870686f * fRec34[1];
			fRec35[0] = 0.870686f * fRec36[0] + fVec13[1] + 1.8685f * (fRec35[1] - fRec36[1]);
			fRec34[0] = fRec35[0];
			output0[i0] = FAUSTFLOAT(fSlow2 * fRec0[0] + fSlow1 * (fRec24[0] * fRec28[0] + fRec29[0] * fRec33[0]) + fRec34[0]);
			float fTemp27 = fRec5[0] + fRec7;
			fVec14[0] = fTemp27;
			fRec43[0] = fConst2 * fRec43[1] + 0.70710677f * (fVec14[1] - fConst2 * fTemp27);
			fVec15[0] = 0.260502f * fRec41[1] - 0.5f * fRec43[1];
			fRec42[0] = fVec15[1] + 0.130251f * fRec43[0] - (0.02569f * fRec42[1] + 0.012845f * fRec43[1]);
			fRec41[0] = fRec42[0];
			fVec16[0] = fRec41[1] - 0.870686f * fRec39[1];
			fRec40[0] = 0.870686f * fRec41[0] + fVec16[1] + 1.8685f * (fRec40[1] - fRec41[1]);
			fRec39[0] = fRec40[0];
			float fTemp28 = 0.70710677f * fVec14[1];
			fVec17[0] = fTemp28 + 0.260502f * fRec46[1];
			fRec47[0] = fVec17[1] + 0.018165573f * fVec14[1] - (0.02569f * fRec47[1] + 0.18420273f * fTemp27);
			fRec46[0] = fRec47[0];
			fVec18[0] = fRec46[1] - 0.870686f * fRec44[1];
			fRec45[0] = 0.870686f * fRec46[0] + fVec18[1] + 1.8685f * (fRec45[1] - fRec46[1]);
			fRec44[0] = fRec45[0];
			float fTemp29 = 3.1415927f * fTemp5;
			fRec48[0] = fConst18 * std::cos(fTemp29) + fConst19 * fRec48[1];
			fVec19[0] = fTemp28 - 0.94657f * fRec51[1];
			fRec52[0] = 1.94632f * fRec52[1] + fVec19[1] + 0.66932607f * fTemp27 - 1.3762561f * fVec14[1];
			fRec51[0] = fRec52[0];
			fVec20[0] = fRec51[1] - 0.06338f * fRec49[1];
			fRec50[0] = 0.06338f * fRec51[0] + fVec20[1] + 0.83774f * (fRec50[1] - fRec51[1]);
			fRec49[0] = fRec50[0];
			fRec53[0] = fConst18 * std::sin(fTemp29) + fConst19 * fRec53[1];
			output1[i0] = FAUSTFLOAT(fSlow2 * fRec39[0] + fSlow1 * (fRec44[0] * fRec48[0] + fRec49[0] * fRec53[0]) + fRec34[0]);
			iVec0[1] = iVec0[0];
			fRec16[1] = fRec16[0];
			fRec17[1] = fRec17[0];
			iRec18[1] = iRec18[0];
