...
class PamRotaryEffect : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow6 = ((iSlow5) ? 0.0f : std::exp(-(fConst4 / ((iSlow5) ? 1.0f : fSlow4))));
		float fSlow7 = fSlow3 * std::pow(float(fHslider2) / fSlow3, float(fHslider3)) * (1.0f - float(fHslider4)) * (1.0f - fSlow6);
		float fSlow8 = 1.414f * std::pow(1e+01f, 0.15f * fSlow0);
		float fSlow9 = 0.01f * float(fHslider6);
		float fSlow10 = std::sqrt(fSlow9);
		float fSlow11 = std::sqrt(1.0f - fSlow9);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			int iTemp0 = 1 - iVec0[1];
			fRec10[0] = fSlow7 + fSlow6 * fRec10[1];
			float fTemp1 = ((iTemp0) ? 1.5707964f : fRec9[1] - fConst4 * fRec10[0]);
			fRec9[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = std::cos(6.2831855f * fRec9[0] + -3.1415927f);
			float fTemp3 = fConst3 * (fTemp2 + 1.0f);
			float fTemp4 = fTemp3 + 5e-06f;
			float fTemp5 = std::floor(fTemp4);
			fRec11[IOTA0 & 31] = -(fConst2 * (fConst5 * fRec11[(IOTA0 - 1) & 31] + 0.16666667f * (fRec5[1] + fRec5[2])));
			fRec12[IOTA0 & 31] = -(fConst2 * (fConst5 * fRec12[(IOTA0 - 1) & 31] + 0.16666667f * (fRec4[1] + fRec4[2])));
			float fTemp6 = float(input0[i0]);
			fVec1[0] = fTemp6;
			fRec13[0] = -(fConst7 * (fConst8 * fRec13[1] - fConst6 * (fTemp6 - fVec1[1])));
			fVec2[IOTA0 & 63] = fSlow10 * fRec13[0];
			float fTemp7 = 0.5f * (fRec11[(IOTA0 - 17) & 31] + fRec11[(IOTA0 - 31) & 31] + fRec12[(IOTA0 - 11) & 31] + fRec12[(IOTA0 - 23) & 31] + fRec12[IOTA0 & 31] + fRec11[IOTA0 & 31]) + fSlow8 * fVec2[(IOTA0 - 48) & 63];
			...
			fVec4[0] = fTemp9;
			fRec8[0] = fConst2 * (fTemp9 + fVec4[1] - fConst5 * fRec8[1]);
			fRec4[0] = fRec8[0];
			...
			float fTemp12 = fConst3 * (fTemp11 + 1.0f);
			...
			fVec5[0] = fTemp16;
			fRec14[0] = -(fConst2 * (fConst5 * fRec14[1] - (fTemp16 + fVec5[1])));
			fRec5[0] = fRec14[0];
			...
			fRec20[0] = 1.94632f * fRec20[1] + fVec9[1] + 0.66932607f * fTemp17 - 1.3762561f * fVec6[1];
			fRec19[0] = fRec20[0];
			...
			float fTemp20 = fSlow11 * fRec13[0] + fRec26[0];
			fVec11[0] = fTemp20;
			...
			fRec23[0] = 0.870686f * fRec24[0] + fVec13[1] + 1.8685f * (fRec23[1] - fRec24[1]);
			fRec22[0] = fRec23[0];
			...
			fVec15[0] = fTemp22 + 0.260502f * fRec29[1];
			fRec30[0] = fVec15[1] + 0.018165573f * fVec14[1] - (0.18420273f * fTemp21 + 0.02569f * fRec30[1]);
			fRec29[0] = fRec30[0];
			fVec16[0] = fRec29[1] - 0.870686f * fRec27[1];
			fRec28[0] = 0.870686f * fRec29[0] + fVec16[1] + 1.8685f * (fRec28[1] - fRec29[1]);
			fRec27[0] = fRec28[0];
			float fTemp23 = 3.1415927f * fTemp2;
			fRec31[0] = fConst10 * std::cos(fTemp23) + fConst11 * fRec31[1];
			fVec17[0] = fTemp22 - 0.94657f * fRec34[1];
			fRec35[0] = 1.94632f * fRec35[1] + fVec17[1] + 0.66932607f * fTemp21 - 1.3762561f * fVec14[1];
			fRec34[0] = fRec35[0];
			fVec18[0] = fRec34[1] - 0.06338f * fRec32[1];
			fRec33[0] = 0.06338f * fRec34[0] + fVec18[1] + 0.83774f * (fRec33[1] - fRec34[1]);
			fRec32[0] = fRec33[0];
