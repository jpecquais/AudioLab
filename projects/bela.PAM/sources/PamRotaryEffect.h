 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec14[0] = -(fConst6 * (fConst7 * fRec14[1] - (fRec15[0] + fRec15[1])));
			fRec13[0] = -(fConst6 * (fConst7 * fRec13[1] - (fRec14[0] + fRec14[1])));
			fRec12[0] = fConst6 * (fRec13[0] + fRec13[1] - fConst7 * fRec12[1]);
			fRec11[0] = fConst6 * (fRec12[0] + fRec12[1] - fConst7 * fRec11[1]);
			fRec10[0] = fConst6 * (fRec11[0] + fRec11[1] - fConst7 * fRec10[1]);
			...
			float fTemp26 = 0.70710677f * (fSlow2 * fRec0[0] + fSlow1 * (fRec24[0] * fRec28[0] + fRec29[0] * fRec33[0]));
			fRec38[0] = -(fConst15 * (fConst16 * fRec38[1] - (fTemp12 + fVec1[1])));
			float fTemp27 = fRec38[0] + fSlow10 * fRec22[0];
			fVec11[0] = fTemp27;
			fVec12[0] = 0.260502f * fRec36[1] + fVec11[1];
			fRec37[0] = fVec12[1] - (0.02569f * (fRec37[1] - fVec11[1]) + 0.260502f * fTemp27);
			fRec36[0] = fRec37[0];
			fVec13[0] = fRec36[1] - 0.870686f * fRec34[1];
			fRec35[0] = 1.8685f * (fRec35[1] - fRec36[1]) + fVec13[1] + 0.870686f * fRec36[0];
			fRec34[0] = fRec35[0];
			output0[i0] = FAUSTFLOAT(fTemp26 + fRec34[0]);
			float fTemp28 = fRec5[0] + fRec7;
			fVec14[0] = fTemp28;
			fRec43[0] = fConst2 * fRec43[1] + 0.70710677f * (fVec14[1] - fConst2 * fTemp28);
			...
			fRec39[0] = fRec40[0];
			float fTemp29 = 0.70710677f * fVec14[1];
			fVec17[0] = fTemp29 + 0.260502f * fRec46[1];
			fRec47[0] = fVec17[1] + 0.018165573f * fVec14[1] - (0.02569f * fRec47[1] + 0.18420273f * fTemp28);
			fRec46[0] = fRec47[0];
			fVec18[0] = fRec46[1] - 0.870686f * fRec44[1];
			fRec45[0] = 0.870686f * fRec46[0] + fVec18[1] + 1.8685f * (fRec45[1] - fRec46[1]);
			fRec44[0] = fRec45[0];
			float fTemp30 = 3.1415927f * fTemp5;
			fRec48[0] = fConst18 * std::cos(fTemp30) + fConst19 * fRec48[1];
			fVec19[0] = fTemp29 - 0.94657f * fRec51[1];
			fRec52[0] = 1.94632f * fRec52[1] + fVec19[1] + 0.66932607f * fTemp28 - 1.3762561f * fVec14[1];
			fRec51[0] = fRec52[0];
			fVec20[0] = fRec51[1] - 0.06338f * fRec49[1];
			fRec50[0] = 0.06338f * fRec51[0] + fVec20[1] + 0.83774f * (fRec50[1] - fRec51[1]);
			fRec49[0] = fRec50[0];
			fRec53[0] = fConst18 * std::sin(fTemp30) + fConst19 * fRec53[1];
			output1[i0] = FAUSTFLOAT(fSlow2 * fRec39[0] + fSlow1 * (fRec44[0] * fRec48[0] + fRec49[0] * fRec53[0]) + fTemp26 + fRec34[0]);
			iVec0[1] = iVec0[0];
			fRec16[1] = fRec16[0];
			fRec17[1] = fRec17[0];
			iRec18[1] = iRec18[0];
