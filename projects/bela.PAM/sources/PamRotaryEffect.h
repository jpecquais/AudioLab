...
class PamRotaryEffect : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = float(fHslider6);
		int iSlow5 = std::fabs(fSlow4) < 1.1920929e-07f;
		float fSlow6 = ((iSlow5) ? 0.0f : std::exp(-(fConst8 / ((iSlow5) ? 1.0f : fSlow4))));
		float fSlow7 = (1.0f - float(fHslider2)) * ((int(float(fHslider3))) ? float(fHslider5) : float(fHslider4)) * (1.0f - fSlow6);
		float fSlow8 = 1.4125376f * std::pow(1e+01f, 0.15f * fSlow2);
		float fSlow9 = std::sqrt(fSlow0);
		float fSlow10 = 1.0f - fSlow3;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec16[0] = fSlow7 + fSlow6 * fRec16[1];
			...
			fRec22[0] = float(1 - iTemp3) * fRec22[1] + 4.656613e-10f * float(iRec25[0]) * float(iTemp3);
			fRec21[0] = fConst10 * (fRec22[0] + fRec22[1] - fConst14 * fRec21[1]);
			fRec20[0] = fConst10 * (fRec21[0] + fRec21[1] - fConst14 * fRec20[1]);
			fRec19[0] = fConst10 * (fRec20[0] + fRec20[1] - fConst14 * fRec19[1]);
			fRec18[0] = fConst10 * (fRec19[0] + fRec19[1] - fConst14 * fRec18[1]);
			fRec17[0] = fConst10 * (fRec18[0] + fRec18[1] - fConst14 * fRec17[1]);
			...
			float fTemp14 = fSlow9 * fRec5[0];
			fVec5[IOTA0 & 255] = fTemp14;
			int iTemp15 = int(fTemp12);
			float fTemp16 = 0.5f * (fRec26[(IOTA0 - 31) & 31] + fRec26[(IOTA0 - 17) & 31] + fRec27[(IOTA0 - 23) & 31] + fRec27[(IOTA0 - 11) & 31] + fRec27[IOTA0 & 31] + fRec26[IOTA0 & 31]) + fSlow8 * ((fTemp11 - fTemp13) * fVec5[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp15 + 1))) & 255] - fVec5[(IOTA0 - std::min<int>(192, std::max<int>(0, iTemp15))) & 255] * (fTemp11 + (-1.0f - fTemp13)));
			...
			fRec34[0] = fVec12[1] + 0.66932607f * fTemp26 + 1.94632f * fRec34[1] - 1.3762561f * fVec9[1];
			fRec33[0] = fRec34[0];
			...
			float fTemp29 = fRec0[0] + 0.70710677f * (fSlow3 * (fRec6[0] * fRec30[0] + fRec31[0] * fRec35[0]) + fSlow10 * fRec6[0]);
			...
			output1[i0] = FAUSTFLOAT(fTemp29 + fSlow10 * fRec36[0] + fSlow3 * (fRec36[0] * fRec40[0] + fRec41[0] * fRec45[0]));
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			fRec4[1] = fRec4[0];
			fRec5[1] = fRec5[0];
