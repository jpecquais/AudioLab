 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec12[IOTA0 & 31] = -(fConst2 * (fConst5 * fRec12[(IOTA0 - 1) & 31] + 0.16666667f * (fRec4[2] + fRec4[1])));
			float fTemp6 = float(input0[i0]);
			fVec1[0] = fTemp6;
			fRec13[0] = -(fConst7 * (fConst8 * fRec13[1] - fConst6 * (fTemp6 - fVec1[1])));
			fVec2[IOTA0 & 63] = fSlow10 * fRec13[0];
			float fTemp7 = 0.5f * (fRec11[(IOTA0 - 31) & 31] + fRec12[(IOTA0 - 11) & 31] + fRec12[(IOTA0 - 23) & 31] + fRec11[(IOTA0 - 17) & 31] + fRec12[IOTA0 & 31] + fRec11[IOTA0 & 31]) + fSlow8 * fVec2[(IOTA0 - 48) & 63];
			...
			float fTemp20 = fRec26[0] + fSlow11 * fRec13[0];
			fVec11[0] = fTemp20;
