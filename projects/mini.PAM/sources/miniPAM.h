 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec22[0] = fTemp43;
			fVec23[0] = 0.2806469791703976 * fVec22[1] - 0.584511859220467 * fRec62[1];
			fRec63[0] = fVec23[1] + 0.7401425791353778 * fVec22[1] + 0.5 * fTemp43 - 1.329712910006014 * fRec63[1];
			fRec62[0] = fRec63[0];
			fVec24[0] = 0.5109642076671005 * fRec62[1] - 0.8549735054220843 * fRec60[1];
			fRec61[0] = fVec24[1] + 1.087818286794955 * fRec62[1] + fRec62[0] + 0.06313815899767035 * fRec61[1];
			fRec60[0] = fRec61[0];
			fVec25[0] = 0.8557230539187167 * fRec60[1] - 0.8642103314292185 * fRec58[1];
			fRec59[0] = fVec25[1] + fRec60[0] + 1.190867161726977 * fRec59[1] - 0.2309310102976378 * fRec60[1];
			fRec58[0] = fRec59[0];
			fVec26[0] = 0.8344671400318593 * fRec58[1] - 0.8773776425918851 * fRec56[1];
			fRec57[0] = fVec26[1] + fRec58[0] + 0.5656917969061733 * fRec58[1] - 0.7243277363905964 * fRec57[1];
			fRec56[0] = fRec57[0];
			fVec27[0] = 0.9131235385743239 * fRec56[1] - 0.9021891001928163 * fRec54[1];
			fRec55[0] = fVec27[1] + fRec56[0] + 1.805152469827447 * fRec55[1] - 1.233624797754314 * fRec56[1];
			fRec54[0] = fRec55[0];
			fVec28[0] = 0.8870067245856911 * fRec54[1] - 0.9048660134290324 * fRec52[1];
			fRec53[0] = fVec28[1] + fRec54[0] + 1.629354368480199 * fRec53[1] - 1.754960607390966 * fRec54[1];
			fRec52[0] = fRec53[0];
			fVec29[0] = 0.9718420269745944 * fRec52[1] - 0.9076478247393985 * fRec50[1];
			fRec51[0] = fVec29[1] + fRec52[0] + 0.5697418581588154 * fRec51[1] - 0.6019425747501994 * fRec52[1];
			fRec50[0] = fRec51[0];
			fVec30[0] = 0.9376641822481434 * fRec50[1] - 0.9247986878965425 * fRec48[1];
			fRec49[0] = fVec30[1] + fRec50[0] + 1.520752451778902 * fRec49[1] - 1.566962438216134 * fRec50[1];
			fRec48[0] = fRec49[0];
			fVec31[0] = 0.9561192703046787 * fRec48[1] - 0.9443777901504549 * fRec46[1];
			fRec47[0] = fVec31[1] + fRec48[0] + 1.705858997437663 * fRec47[1] - 1.713553328167775 * fRec48[1];
			fRec46[0] = fRec47[0];
			fVec32[0] = 0.9889504252634936 * fRec46[1] - 0.9508136470443349 * fRec44[1];
			fRec45[0] = fVec32[1] + fRec46[0] + 1.468777086795595 * fRec45[1] - 1.494157095280939 * fRec46[1];
			fRec44[0] = fRec45[0];
			fVec33[0] = 0.981534145429839 * fRec44[1] - 0.9558053486317599 * fRec42[1];
			fRec43[0] = fVec33[1] + fRec44[0] + 0.9953224449142039 * fRec43[1] - 0.9885667518321737 * fRec44[1];
			fRec42[0] = fRec43[0];
			fVec34[0] = 0.9772722637558424 * fRec42[1] - 0.9570006694359301 * fRec40[1];
			fRec41[0] = fVec34[1] + fRec42[0] + 1.646917434186092 * fRec41[1] - 1.671828560589215 * fRec42[1];
			fRec40[0] = fRec41[0];
			fVec35[0] = 0.9405551174112289 * fRec40[1] - 0.9715751460580376 * fRec38[1];
			fRec39[0] = fVec35[1] + fRec40[0] + 1.960202685508744 * fRec39[1] - 1.925830295520375 * fRec40[1];
			fRec38[0] = fRec39[0];
			fVec36[0] = 0.9366707120277227 * fRec38[1] - 0.9747232344107498 * fRec36[1];
			fRec37[0] = fVec36[1] + fRec38[0] + 1.855537873287801 * fRec37[1] - 1.838923017902953 * fRec38[1];
			fRec36[0] = fRec37[0];
			fVec37[0] = 0.9715721407101845 * fRec36[1] - 0.9772682085594049 * fRec34[1];
			fRec35[0] = fVec37[1] + fRec36[0] + 1.879962914019087 * fRec35[1] - 1.863852125298557 * fRec36[1];
			fRec34[0] = fRec35[0];
			fVec38[0] = 0.9208895578235805 * fRec34[1] - 0.9779111848799814 * fRec32[1];
			fRec33[0] = fVec38[1] + fRec34[0] + 1.977493135962734 * fRec33[1] - 1.920692064616606 * fRec34[1];
			fRec32[0] = fRec33[0];
			fVec39[0] = 0.9794557207120638 * fRec32[1] - 0.9795223224811943 * fRec30[1];
			fRec31[0] = fVec39[1] + fRec32[0] + 1.930741635326339 * fRec31[1] - 1.930336495963867 * fRec32[1];
			fRec30[0] = fRec31[0];
			fVec40[0] = 0.9863130602785319 * fRec30[1] - 0.9798409599744299 * fRec28[1];
			fRec29[0] = fVec40[1] + fRec30[0] + 1.798385141637081 * fRec29[1] - 1.805112558301939 * fRec30[1];
			fRec28[0] = fRec29[0];
			fVec41[0] = 0.9596436221385279 * fRec28[1] - 0.981956253733703 * fRec26[1];
			fRec27[0] = fVec41[1] + fRec28[0] + 1.836494246332821 * fRec27[1] - 1.82243059246854 * fRec28[1];
			fRec26[0] = fRec27[0];
			fVec42[0] = 0.9897667806355812 * fRec26[1] - 0.9830248212232819 * fRec24[1];
			fRec25[0] = fVec42[1] + fRec26[0] + 1.956727295705248 * fRec25[1] - 1.965229527534195 * fRec26[1];
			fRec24[0] = fRec25[0];
			fVec43[0] = 0.9846318647425029 * fRec24[1] - 0.9840886363329261 * fRec22[1];
			fRec23[0] = fVec43[1] + fRec24[0] + 1.952594409962653 * fRec23[1] - 1.952363266320942 * fRec24[1];
			fRec22[0] = fRec23[0];
			fVec44[0] = 0.9784446750553875 * fRec22[1] - 0.9871001087877436 * fRec20[1];
			fRec21[0] = fVec44[1] + fRec22[0] + 1.928851355524848 * fRec21[1] - 1.919793514901131 * fRec22[1];
			fRec20[0] = fRec21[0];
			fVec45[0] = 0.988019426747446 * fRec20[1] - 0.9879758017308583 * fRec18[1];
			fRec19[0] = fVec45[1] + fRec20[0] + 1.948893426625344 * fRec19[1] - 1.948532931326867 * fRec20[1];
			fRec18[0] = fRec19[0];
			fVec46[0] = 0.9870343694812302 * fRec18[1] - 0.9891807385271304 * fRec16[1];
			fRec17[0] = fVec46[1] + fRec18[0] + 1.986499226863611 * fRec17[1] - 1.984241884763906 * fRec18[1];
			fRec16[0] = fRec17[0];
			fVec47[0] = 0.9942731455136986 * fRec16[1] - 0.9897591602297002 * fRec14[1];
			fRec15[0] = fVec47[1] + fRec16[0] + 1.988617901798897 * fRec15[1] - 1.993186663549857 * fRec16[1];
			fRec14[0] = fRec15[0];
			fVec48[0] = 0.9770791015145095 * fRec14[1] - 0.9903015583822944 * fRec12[1];
			fRec13[0] = fVec48[1] + fRec14[0] + 1.96939254727357 * fRec13[1] - 1.956700830694171 * fRec14[1];
			fRec12[0] = fRec13[0];
			fVec49[0] = 0.9908668699846226 * fRec12[1] - 0.9909371967985474 * fRec10[1];
			fRec11[0] = fVec49[1] + fRec12[0] + 1.910966241885816 * fRec11[1] - 1.911258728982635 * fRec12[1];
			fRec10[0] = fRec11[0];
			fVec50[0] = 0.9934464548045676 * fRec10[1] - 0.9917675190880694 * fRec8[1];
			fRec9[0] = fVec50[1] + fRec10[0] + 1.984644966505128 * fRec9[1] - 1.986182625718655 * fRec10[1];
			fRec8[0] = fRec9[0];
			fVec51[0] = 0.9916647585802278 * fRec8[1] - 0.9930040092438907 * fRec6[1];
			fRec7[0] = fVec51[1] + fRec8[0] + 1.989247214871486 * fRec7[1] - 1.987902833642959 * fRec8[1];
			fRec6[0] = fRec7[0];
			fVec52[0] = 0.998520868647801 * fRec6[1] - 0.9930742526667118 * fRec4[1];
			fRec5[0] = fVec52[1] + fRec6[0] + 1.992973102156908 * fRec5[1] - 1.998487534780157 * fRec6[1];
			fRec4[0] = fRec5[0];
			fVec53[0] = 0.9950226420024365 * fRec4[1] - 0.9946386100309307 * fRec2[1];
			fRec3[0] = fVec53[1] + fRec4[0] + 1.978126926091301 * fRec3[1] - 1.978260033774014 * fRec4[1];
			fRec2[0] = fRec3[0];
			fVec54[0] = 0.9973586877195068 * fRec2[1] - 0.9970205326361334 * fRec0[1];
